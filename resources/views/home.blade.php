...
<head>
    ...
    <title>Tech Joint Solution </title>
    <!-- Favicon img -->
...
<body>
                    ...
                    <nav>
                        <ul>
                            <li class="has-megamenu">
                                <a href="index-2-one-page.html">Home</a>
                ...
                <div class="d-none d-xl-flex gap-4">
                    ...
                    <div class="about-three__left-item d-flex flex-wrap gap-2 align-items-center">
                        ...
                        <div class="info">
                            ...
                            <h5 class="text-white">+587-437-5511</h5>
                        </div>
                    </div>
                </div>
    ...
    <main>
            ...
            <div class="swiper banner__slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        ...
                        <div class="slide-bg" data-background="assets/images/banner/3.PNG"></div>
                        <div class="container">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="slide-bg" data-background="assets/images/banner/2.PNG"></div>
                        <div class="container">
                            <div class="banner-two__content text-center">
                                <h4 data-animation="fadeInUp" data-delay=".3s" class="text-white mb-20">
                                    Best IT SOULTION Provider
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="slide-bg" data-background="assets/images/banner/1.PNG"></div>
                        <div class="container">
                            <div class="banner-two__content text-center">
                                <h4 data-animation="fadeInUp" data-delay=".3s" class="text-white mb-20">
                                    Best IT SOULTION Provider
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="about-two__left-item">
                            ...
                            <div class="image big-image">
                                <img src="assets/images/about/Untitled design (1).png" alt="image">
                            </div>
                    ...
                    <div class="col-xl-6">
                        <div class="section-header mb-40">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Ensuring Your
                                Driving Success Through Cutting-Edge IT Solutions </h2>
                            <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">

                                At TechJoint, we are dedicated to empowering businesses with innovative and reliable IT
                                services. From technology consulting to ongoing maintenance and support, our team
                                ensures seamless and scalable solutions tailored to your needs.

                                With expertise in web development, digital marketing, and UI/UX design, we turn
                                challenges into opportunities, delivering results that drive growth and enhance your
                                digital presence.</p>
                        </div>
                        <div class="about-two__right-item wow fadeInDown" data-wow-delay="200ms"
                            ...
                            <ul>
                                ...
                                <li><i class="fa-solid fa-check"></i>Expert guidance to align IT strategies with
                                    business goals</li>
                            </ul>
                            <ul>
                                <li><i class="fa-solid fa-check"></i>Top-Tier Services</li>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="service-two__item">
                                ...
                                <div class="service-two__content">
                                    <div class="icon">
                                        <img src="assets/images/icon/icons8-web-development-50.png" alt="icon">
                                    </div>
                                    ...
                                    <p>Create stunning, responsive websites that drive engagement and conversions. Our
                                        expert developers build scalable web solutions to enhance your online
                                        presence</p>
                        ...
                        <div class="swiper-slide">
                            <div class="service-two__item">
                                ...
                                <div class="service-two__content">
                                    <div class="icon">
                                        <img src="assets/images/icon/icons8-digital-marketing-50.png" alt="icon">
                                    </div>
                                    <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                            alt="shape"></div>
                                    <h4><a href="service-details.html" class="primary-hover">Digital Marketing</a></h4>
                                    <p>Boost your brand’s visibility with targeted digital marketing strategies. From
                                        PPC campaigns to social media management, we help you achieve measurable results
                                    </p>
                                    <!-- <a class="read-more-btn" href="service-details.html">Read More <i
                                            class="fa-regular fa-arrow-right-long"></i></a> -->
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-two__item">
                                ...
                                <div class="service-two__content">
                                    <div class="icon">
                                        <img src="assets/images/icon/icons8-developer-mode-50.png" alt="icon">
                                    </div>
                                    <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                            alt="shape"></div>
                                    <h4><a href="service-details.html" class="primary-hover">App Development</a></h4>
                                    <p>Transform your ideas into powerful mobile and web applications with our custom
                                        app development services. We deliver intuitive, high-performance solutions
                        ...
                        <div class="swiper-slide">
                            <div class="service-two__item">
                                ...
                                <div class="service-two__content">
                                    <div class="icon">
                                        <img src="assets/images/icon/icons8-design-50.png" alt="icon">
                                    </div>
                                    <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                            alt="shape"></div>
                                    <h4><a href="service-details.html" class="primary-hover">Graphic Design</a></h4>
                                    <p>Bring your brand to life with visually striking graphic designs. From logos to
                                        marketing materials, we craft designs that leave a lasting impression</p>
                                    <!-- <a class="read-more-btn" href="service-details.html">Read More <i
                                            class="fa-regular fa-arrow-right-long"></i></a> -->
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="service-two__item">
                                ...
                                <div class="service-two__content">
                                    <div class="icon">
                                        <img src="assets/images/icon/icons8-seo-50.png" alt="icon">
                                    </div>
                                    <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                            alt="shape"></div>
                                    <h4><a href="service-details.html" class="primary-hover">SEO (Search Engine
                                            Optimization)</a></h4>
                                    <p>Optimize your website to rank higher on search engines and attract more traffic.
                                        Our SEO experts ensure your business stays ahead in the competitive digital
                                        landscape</p>
                                    <!-- <a class="read-more-btn" href="service-details.html">Read More <i
                                            class="fa-regular fa-arrow-right-long"></i></a> -->
                                </div>
            ...
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-6 d-block d-lg-none">
                        <div class="image">
                            <img src="assets/images/choose/why'.png" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="section-header mb-40">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">At TechJoint, we
                                are dedicated to empowering businesses with cutting-edge IT services..</h2>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Providing tailored IT solutions to streamline operations and enhance
                                            productivity.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Dedicated support anytime you need assistance, ensuring smooth and
                        ...
                        <div class="progress-area wow fadeInDown mt-40" data-wow-delay="00ms"
                            ...
                            <div class="progress__title mb-10">
                                <h5>Development</h5>
                                <span><span class="progress-count">90</span>%</span>
                            </div>
                            <div class="progress">
                    ...
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="choose__image image">
                            <img src="assets/images/choose/Untitled design (1).png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="project"class="case-two-area secondary-bg pt-120">
                ...
                <div class="swiper case-two__slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="case-two__item">
                                <div class="image case-two__image">
                                    <img src="assets/images/case/1.png" alt="image">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="case-two__item">
                                <div class="image case-two__image">
                                    <img src="assets/images/case/2.png" alt="image">
                                </div>
                                <div class="case-two__content">
                                    <span>Lost Phone Finding System</span>
                        ...
                        <div class="swiper-slide">
                            <div class="case-two__item">
                                <div class="image case-two__image">
                                    <img src="assets/images/case/3.png" alt="image">
                                </div>
                                <div class="case-two__content">
                        ...
                        <div class="swiper-slide">
                            <div class="case-two__item">
                                <div class="image case-two__image">
                                    <img src="assets/images/case/4.png" alt="image">
                                </div>
                                <div class="case-two__content">
                                    <span>Doc Management System App</span>
                                    <h4><a href="case-details.html" class="text-white">Graphic Design</a></h4>
                                </div>
                                <a href="case-details.html" class="case-two__btn">
                                    <i class="fa-regular fa-arrow-right"></i>
                                </a>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-two__item">
                                ...
                                <p class="mb-30">“ TechJoint's app development team turned our vision into a seamless,
                                    user-friendly app that exceeded our expectations. The process was smooth, and the
                                    final product has significantly enhanced our customer engagement. ”</p>
                                <div class="d-flex align-items-center gap-3">
                                    <img src="assets/images/testimonial/icons8-person-skin-type-7-48.png" alt="image">
                                    <div class="con">
                                        <h4>Alex Rony</h4>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-two__item">
                                ...
                                <p class="mb-30">Our new website has transformed our online presence thanks to
                                    TechJoint. The team delivered a stunning, responsive design that not only looks
                                    great but performs exceptionally well. Highly recommended!</p>
                                <div class="d-flex align-items-center gap-3">
                                    <img src="assets/images/testimonial/icons8-person-skin-type-7-48.png" alt="image">
                                    <div class="con">
                                        <h4>John Carter</h4>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-two__item">
                                ...
                                <p class="mb-30">TechJoint's digital marketing strategies have been a game-changer for
                                    us. With their expertise in social media campaigns and PPC ads, our traffic and
                                    conversions have skyrocketed!</p>
                                <div class="d-flex align-items-center gap-3">
                                    <img src="assets/images/testimonial/icons8-person-skin-type-7-48.png" alt="image">
        ...
        <div class="container">
            <div class="footer__wrp pt-100 pb-100">
                <div class="footer__item item-big wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                    ...
                    <p>Let us elevate your business with expert guidance and solutions designed to achieve success.
                ...
                <div class="footer__item item-sm wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    ...
                    <ul>
                        <li><a href="service-details.html"><i class="fa-regular fa-angles-right me-1"></i> App
                                Development</a></li>
                        ...
                        <li><a href="service-details.html"><i class="fa-regular fa-angles-right me-1"></i> Graphic
                                Design</a></li>
                        <li><a href="service-details.html"><i class="fa-regular fa-angles-right me-1"></i> Digtal
                                Marketing</a></li>
                    </ul>
                </div>
                <div class="footer__item item-sm wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    ...
                    <ul>
                        <li><a href="about.html"><i class="fa-regular fa-angles-right me-1"></i> About Techjoint</a></li>
                        <!-- <li><a href="service.html"><i class="fa-regular fa-angles-right me-1"></i> Our Services</a>
                        </li> -->
                        <li><a href="contact.html"><i class="fa-regular fa-angles-right me-1"></i> Contact Us</a>
                        </li>
                        <li><a href="case.html"><i class="fa-regular fa-angles-right me-1"></i> Our Projects</a></li>
                        <li><a href="team.html"><i class="fa-regular fa-angles-right me-1"></i> Our services</a></li>
                    </ul>
                </div>
                <div class="footer__item item-big wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <h3 class="footer-title">Contact Us</h3>
                    <p class="mb-20">Canada,Calgary,Alberta</p>
